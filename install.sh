...
ASSET_URL=$(echo "$ASSET_URLS" | grep "finx-$PLATFORM_ARCH")
...
sudo mv "$TMP_DOWNLOAD_PATH" "$DOWNLOAD_DIR/finx"

echo "finx installed successfully in $DOWNLOAD_DIR"
